...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
    ...
    <button onClick={()=> setIsNavbarExpended(!isNavbarExpended)} data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
    ...
    <div  class={clsx(" gap-x-10  gap-y-5 w-full  sm:items-center flex flex-col md:flex-row md:w-auto",!isNavbarExpended && "hidden md:flex")} id="navbar-default">
      <ul class="font-medium  flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Enterprise</a>
        </li>
        <li>
      ...
      <ul className="flex content-center  space-x-5  justify-center font-questrial text-sm sm:text-base font-bold sm:font-semibold ">
            <button className=" py-2 text-nowrap">Log In</button>
             <button className=" p-2 text-white bg-blue-500 rounded-3xl text-nowrap">
               Sign up free
             </button>
           </ul>
    </div>
